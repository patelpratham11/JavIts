...
public class HabitTracker {
    ...
    public static void remindersMenu(){
        System.out.println("What would you like to do?\nEnter the number below.");
        System.out.printf("| %-15s | %-1s |%n", "View Reminders", 1 );
        System.out.printf("| %-15s | %-1s |%n", "Add Reminders", 2 );
        System.out.printf("| %-15s | %-1s |%n", "Add New Reminders", 3 );
        System.out.printf("| %-15s | %-1s |%n", "Quit", 4 );
